# -*- encoding: utf-8 -*-
# stub: cucumber-core 9.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-core-9.0.1".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, ["~> 3.0", ">= 3.0.1"])
      ...
      s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.15", ">= 1.15.0"])
      ...
      s.add_dependency(%q<cucumber-tag-expressions>.freeze, ["~> 3.0", ">= 3.0.1"])
      ...
      s.add_dependency(%q<rubocop>.freeze, ["~> 1.15", ">= 1.15.0"])
